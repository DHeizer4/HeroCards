...
namespace Cards_Games.Enumerations
{
    ...
    {                                                                                           //Special card   40 card deck
        public enum CharacterRace { Lapine,     // French for Rabbit    Fast Caster             Reproduce:  makes mirror images
                                    Minotaur,   // Bull Person          Warrior                 Bull rush  Trample card?  how would trample work
                                    ...
                                    Centaur,    // Horse Person         Fast strength based     
                                    Ailuran,    // Cat person           High Crit caster        Focus:  incease dex and Agility  Roar???
                                    Saytr,      // Goat person          Support race            Tea Party.  Restores all players to full health and removes all buffs and debuffs
                                    Vanara,     // Monkey person        Trickster               Distraction maker  summons a 1 hp taunting target / redirecting target
                                    Aarakocra,  // Bird person          Concentration Based     Soar into air while in air can't be hit until next action
